              ...
              builder: (context, snapshot) {
                ...
                if (isLoggedInFlag == null || isLoggedInFlag == '0') {
                  return GuestUserDrawerWidget(
                    message: getTranslated(context, 'Sign_in_to_see_profile'),
                ...
                if (!isTokenValid) {
                  return GuestUserDrawerWidget(
                    message: getTranslated(
                      context,
                      'Session_expired_Sign_in_to_see_profile',
                    ),
                    currentTask: VIEWING_PROFILE,
                  );
                }
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          Text(
                            getTranslated(context, 'Name_key_2'),
                            style: TextStyle(
                              fontSize: 20,
                            ),
                          ),
                          ...
                          Text(
                            getTranslated(context, 'Email_key'),
                            style: TextStyle(
                              fontSize: 20,
                            ),
                          ),
                    ...
                    child: task == CHANGING_NAME
                        ...
                        ? TextFormField(
                            decoration: InputDecoration(
                              ...
                              hintText: getTranslated(context, 'e_g_ahemd'),
      ...
      builder: (BuildContext context) {
        ...
        return Padding(
          ...
          child: RaisedButton(
            ...
            child: Text(
              getTranslated(context, 'Confirm_sign_out'),
              style: TextStyle(
                color: Colors.white,
                fontSize: 18,
              ),
